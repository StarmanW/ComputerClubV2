 ...
 * Time: 9:25 PM
 */
require $_SERVER['DOCUMENT_ROOT'] . '/ComputerClub/vendor/autoload.php';
...
class DB {
    ...
    //Data fields
    const paths = array("C:/xampp/htdocs/ComputerClub/application/includes/entity/");
    ...
    private function getDBConnData() {
        ...
        $config = parse_ini_file($_SERVER['DOCUMENT_ROOT'] . '/ComputerClub/config.ini');
