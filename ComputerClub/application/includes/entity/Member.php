...
class Member {
    ...
    private $memberID;
    /**
     * @ORM\ManyToOne(targetEntity="Programme", inversedBy="progID")
     ...
     * Member constructor.
     */
    public function __construct($memberID, $programme, $firstName, $lastName, $memberEmail, $memberContact, $memberIC, $gender, $feeStatus, $position, $academicYear, $password) {
