<?php
    ...
    include $_SERVER['DOCUMENT_ROOT'] . "/ComputerClubV2/application/includes/service/EventService.php";
                        ...
                        for ($i = 0; $i < sizeof($events); $i++):?>
                            <tr>
                                ...
                                <td class="body-item mbr-fonts-style display-7">
                                    <a href="eventInfo.php?e=<?php echo $events[$i]->getEventID()?>"><button type="button" name="edit" class="edit-button"><img src="../assets/images/info.svg" /></button></a>
                                </td>
                            </tr>
                        <?php endfor; ?>
                        </tbody>
